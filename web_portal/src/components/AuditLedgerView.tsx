      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 }}>
        {[
          ...
          },
          {
            ...
            sub: "Audited across NIFTY & F&O Watchlists",
            color: "#06b6d4",
          },
          {
      ...
      >
        ...
        <div style={{ fontSize: 11.5, color: "#cbd5e1", lineHeight: 1.5 }}>
          {summary?.audit_methodology ||
            "Every alert generated by StokVigil AI is assigned a cryptographic record upon dispatch. Signal outcomes are verified using tick-level high and low prices from the National Stock Exchange of India. A signal is verified as 'TARGET_1_REACHED' only if price achieves Target 1 prior to breaching the protective stop-loss floor."}
        </div>
      </div>
