  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24, width: "100%" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 }}>
        {[
          {
            title: "TACTICAL BENCHMARK HIT RATE",
            value:
              summary && summary.total_verified_signals > 0
                ...
                ? "..."
                : "--",
            sub: "Model backtest hitting Tactical Level 1 before SL",
            color: "#10b981",
          },
          {
      ...
      >
        ...
        <div style={{ fontSize: 11.5, color: "#cbd5e1", lineHeight: 1.5 }}>
          {summary?.audit_methodology ||
            "Every alert generated by StokVigil AI is assigned a cryptographic record upon dispatch. Signal outcomes are verified using tick-level high and low prices from the National Stock Exchange of India (NSE) and Bombay Stock Exchange (BSE). A signal is verified as 'TARGET_1_REACHED' only if price achieves the 1.5x ATR Tactical Benchmark prior to breaching the protective stop-loss floor. Levels represent volatility benchmarks, not guaranteed profit targets."}
        </div>
      </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: 11.5 }}>
            <thead>
              <tr style={{ background: "rgba(255, 255, 255, 0.02)", borderBottom: "1px solid rgba(255, 255, 255, 0.08)" }}>
                ...
                <th style={{ padding: "12px 14px", color: "#94a3b8", fontWeight: 700 }}>TACTICAL BENCHMARK 1</th>
